...
cfg.var        = ft_getopt(cfg, 'var',      []); % AJ HACK
...
if strcmp(cfg.maskstyle, 'difference')
  ...
  ft_plot_vector(xval, yval, 'color', permute(linecolor, [3 2 1]), 'style', ...
      linestyle(1,:), 'linewidth', linewidth(1,:), 'highlight', mask, ...
      'highlightstyle', cfg.maskstyle, 'hlim', [xmin xmax], 'vlim', [ymin ymax],...
      'facealpha', cfg.maskfacealpha,'facecolor',cfg.facecolor);
else
